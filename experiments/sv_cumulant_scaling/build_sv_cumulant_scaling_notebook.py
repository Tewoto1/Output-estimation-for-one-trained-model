...
(see experiments/_nb.py). It tests, on the existing trained-to-0 checkpoints
...
Run:  python experiments/sv_cumulant_scaling/build_sv_cumulant_scaling_notebook.py
"""
import os, sys
